...
function CTA() {
  return (
    <section className="px-6 py-16">
      <div
        data-aos="fade-up"
        className="mx-auto max-w-5xl rounded-3xl border border-indigo-500/20 bg-white/[0.02] p-12 text-center"
      >
        ...
        <p className="mx-auto mb-8 max-w-2xl text-slate-400">
          Create secure video meetings, collaborate in real-time, share screens
          and communicate with your team from anywhere.
        </p>
